...
from gitsearch.strategy import EstrategiaGit, seleccionar_estrategia
...
class TestSeleccionarEstrategia:
    ...
    def test_retorna_instancia_estrategia_git(self) -> None:
        """Test returns EstrategiaGit instance."""
        result = seleccionar_estrategia({"texto": "test"})
        assert isinstance(result, EstrategiaGit)
